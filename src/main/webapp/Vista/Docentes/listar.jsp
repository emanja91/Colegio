<%-- 
    Document   : listar
    Created on : 3/10/2025, 10:35:43 a. m.
    Author     : manja
--%>
...
<html>
    ...
    <body>
       <div class="custom-container">
            <h2 class="custom-title text-center">Centro Educativo de Barranquilla | Gestión de Docentes</h2>
            <hr/>
            <div class="d-flex justify-content-end mb-3">
                <a href="${pageContext.request.contextPath}/DocenteController?accion=nuevo" class="btn btn-success btn-sm"> <i class="fa-solid fa-address-book"></i> Nuevo Docente</a>
            </div>
            ...
            <table class ="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <c:forEach items="${docentes}" var="item" >
                        <tr>
                            <td>${item.id}</td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="DocenteController?accion=editar&id=${item.id}" class="btn btn-warning btn-sm">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                    <a href="DocenteController?accion=eliminar&id=${item.id}" class="btn btn-danger btn-sm">
