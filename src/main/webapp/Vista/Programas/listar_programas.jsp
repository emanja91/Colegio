<%-- 
    ...
    Created on : 10/10/2025, 12:33:44 p. m.
    Author     : manja
--%>
...
<html>
    ...
    <body>
        <div class="custom-container">
            <h2 class="custom-title text-center">Centro Educativo de Barranquilla | Gestión de Programas</h2>
            <hr/>
            <div class="d-flex justify-content-end mb-3">
                <a href="ProgramaController?accion=nuevo" class="btn btn-success btn-sm"> <i class="fa-solid fa-address-book"></i> Nuevo Programa</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="ProgramaController?accion=editar&id=${item.id_programa}" class="btn btn-warning btn-sm">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                    <a href="ProgramaController?accion=eliminar&id=${item.id_programa}" class="btn btn-danger btn-sm">
